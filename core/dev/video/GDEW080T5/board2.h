...
#define TPS_PWRCOM_PORT			GPIOA			//OUT - PP		H:PWRCOM    yes   ԭΪPB3
#define TPS_PWRCOM_PIN			GPIO_Pin_0
#define AVT_HCS_PORT			GPIOA			//OUT - PP		L:EN    yes   ԭΪPA15
#define AVT_HCS_PIN				GPIO_Pin_1
#define AVT_RST_PORT			GPIOA			//OUT - PP		L:Reset			yes	
#define AVT_RST_PIN				GPIO_Pin_2
#define AVT_RDY_PORT			GPIOA			//IN - NOPULL   RDY      			yes	
#define AVT_RDY_PIN				GPIO_Pin_3


#define KEY_01_PORT				GPIOA			//IN - PULLUP
#define KEY_01_PIN				GPIO_Pin_5
#define KEY_02_PORT				GPIOA			//IN - PULLUP
#define KEY_02_PIN				GPIO_Pin_6
*/
...
#define TPS_PWRCOM_PORT			GPIOA			//OUT - PP		H:PWRCOM    yes   ?-?aPB3
#define TPS_PWRCOM_PIN			GPIO_Pin_0
#define AVT_HCS_PORT			GPIOA			//OUT - PP		L:EN    yes   ?-?aPA15
#define AVT_HCS_PIN				GPIO_Pin_1
#define AVT_RST_PORT			GPIOA			//OUT - PP		L:Reset			yes	
#define AVT_RST_PIN				GPIO_Pin_2
#define AVT_RDY_PORT			GPIOA			//IN - NOPULL   RDY      			yes	
...
#define AVT_HWE_PORT			GPIOB			//OUT - PP		L:EN    yes
...
#define AVT_HRD_PORT			GPIOB			//OUT - PP		L:EN       yes
#define AVT_HRD_PIN				GPIO_Pin_8
#define TPS_WAKEUP_PORT			GPIOB			//OUT - PP		H:EN       yes
#define TPS_WAKEUP_PIN			GPIO_Pin_9
#define AVT_IRQ_PORT			GPIOB			//IN - NOPULL            yes
...
//PC��
/*
#define SYS_WAKEUP_PORT			GPIOC			//OUT - PP		H:EN     SYSWAKEUP   yes   ԭΪPB4
#define SYS_WAKEUP_PIN			GPIO_Pin_1

#define LED_01_PORT				GPIOC			//OUT - PP		H:ON
#define LED_01_PIN				GPIO_Pin_2
#define LED_02_PORT				GPIOC			//OUT - PP		H:ON
#define LED_02_PIN				GPIO_Pin_3
*/
...
//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
/*
#define PORT_A_OUT_PP  			TPS_PWRCOM_PIN | AVT_HCS_PIN | AVT_RST_PIN                   	
#define PORT_A_IN_NOPULL		AVT_RDY_PIN
#define PORT_A_IN_PULLUP		KEY_01_PIN|KEY_02_PIN

#define PORT_B_OUT_PP				AVT_HWE_PIN | AVT_HRD_PIN | TPS_WAKEUP_PIN | TPS_PWRUP_PIN 
