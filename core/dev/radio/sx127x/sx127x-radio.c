...
#elif defined( USE_SX1262_RADIO )
/*
    RadioDriver.Init = SX126XInit;
    RadioDriver.Reset = SX126Reset;
    RadioDriver.StartRx = SX126StartRx;
    RadioDriver.GetRxPacket = SX126GetRxPacket;
    RadioDriver.SetTxPacket = SX126SetTxPacket;
    RadioDriver.Process = SX126Process;
*/
#else
    #error "Missing define: USE_XXXXXX_RADIO (ie. USE_SX1272_RADIO)"
#endif    
