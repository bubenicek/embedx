...
//#include "../../Source/dvb_cfg_struct.h"
...
void SX1272FskInit( void )
{
    ...
    // TODO: RBU fix
    //memcpy(&FskSettings, &DVBCfg->Sys.FskSettings, sizeof(tFskSettings));

    SX1272FskSetDefaults( );

    // TODO: RBU fix
//    if (SX1272->RegVersion==0x22)
//     DVB_HW_Status |= DVB_SX1272_SPI_HW_STAT;
...
//        PacketTimeout = ( uint16_t )( round( ( 8.0 * ( ( double )SX1272FskGetPacketPayloadSize( ) ) / ( double )FskSettings.Bitrate ) * 1000.0 ) + 1.0 );
        PacketTimeout = ( uint16_t )( ( ( 8L * ( SX1272FskGetPacketPayloadSize( ) ) / FskSettings.Bitrate ) * 1000.0 ) + 2.0 );
