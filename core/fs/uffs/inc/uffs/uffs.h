...
#define UO_RDONLY		0000		/** read only */
#define UO_WRONLY		0001		/** write only */
#define UO_RDWR		0002		/** read and write */

#define UO_CREATE		0100
#define UO_EXCL			0200
#define UO_TRUNC		01000
#define UO_APPEND		02000		/** append */

#define UO_DIR			0200000		/** open a directory */
#define UO_NOECC		0400000		/** skip ECC when reading file data from media */
...
#define _SEEK_SET		0		/** seek from beginning of file */
#define _SEEK_CUR		1		/** seek from current position */
