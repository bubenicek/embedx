...
#if CONFIG_USE_FUNC_PROFILER
#define FUNC_PROFILER_START()  u32 _tms = uffs_GetCurDateTime();
#define FUNC_PROFILER_END()    uffs_Perror(UFFS_MSG_NOISY, "%s: tmlen = %d (ms)", __FUNCTION__, uffs_GetCurDateTime() - _tms)
#else
#define FUNC_PROFILER_START()
#define FUNC_PROFILER_END()
#endif
