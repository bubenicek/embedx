...
#define US_ISLNK(m)      (((m) & US_IFMT) == US_IFLNK)
#define US_ISREG(m)      (((m) & US_IFMT) == US_IFREG)
#define US_ISDIR(m)      (((m) & US_IFMT) == US_IFDIR)
#define US_ISCHR(m)      (((m) & US_IFMT) == US_IFCHR)
#define US_ISBLK(m)      (((m) & US_IFMT) == US_IFBLK)
#define US_ISFIFO(m)     (((m) & US_IFMT) == US_IFIFO)
#define US_ISSOCK(m)     (((m) & US_IFMT) == US_IFSOCK)
