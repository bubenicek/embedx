 ...
 */
#define UFFS_MAX_SPARE_SIZE     64 //((UFFS_MAX_PAGE_SIZE / 256) * 8)
 ...
 */
#define MAX_DIRTY_PAGES_IN_A_BLOCK  2
...
/**
 * Use function time profiler (add. RB)
 */
#define CONFIG_USE_FUNC_PROFILER        0
