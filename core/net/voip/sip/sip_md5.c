 ...
 * SIP_MD5Context structure, pass it to md5_init, call md5_update as
 ...
 **/
void
sip_md5_init (SIP_MD5Context *ctx)
{
 ...
 **/
void
sip_md5_update (SIP_MD5Context *ctx, const void *buf, size_t len)
{
	unsigned32_t t;
 ...
 **/
void
sip_md5_final (SIP_MD5Context *ctx, unsigned char digest[16])
{
	unsigned32_t count;
	unsigned char *p;
