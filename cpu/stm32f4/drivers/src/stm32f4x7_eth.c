...
#define CFG_ETH_MEM_SECTION   __attribute__((section(".data")))
...
/** @defgroup ETH_Private_Variables
  ...
  */
  ...
  CFG_ETH_MEM_SECTION ETH_DMADESCTypeDef  DMARxDscrTab[ETH_RXBUFNB] __attribute__ ((aligned (4))); /* Ethernet Rx DMA Descriptor */
  CFG_ETH_MEM_SECTION ETH_DMADESCTypeDef  DMATxDscrTab[ETH_TXBUFNB] __attribute__ ((aligned (4))); /* Ethernet Tx DMA Descriptor */
  CFG_ETH_MEM_SECTION uint8_t Rx_Buff[ETH_RXBUFNB][ETH_RX_BUF_SIZE] __attribute__ ((aligned (4))); /* Ethernet Receive Buffer */
  CFG_ETH_MEM_SECTION uint8_t Tx_Buff[ETH_TXBUFNB][ETH_TX_BUF_SIZE] __attribute__ ((aligned (4))); /* Ethernet Transmit Buffer */
...
CFG_ETH_MEM_SECTION ETH_DMA_Rx_Frame_infos RX_Frame_Descriptor;
CFG_ETH_MEM_SECTION __IO ETH_DMA_Rx_Frame_infos *DMA_RX_FRAME_infos;
...
//  __IO uint32_t i = 0;
  ...
  TRACE("%s success finished", __FUNCTION__);
...
{
   return (ETH_ReadPHYRegister(DP83848_PHY_ADDRESS, PHY_BSR) & PHY_Linked_Status) != 0;
}
